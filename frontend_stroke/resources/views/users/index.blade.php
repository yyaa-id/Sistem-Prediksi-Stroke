                        ...
                        <form action="{{ route('users.store') }}" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    <input type="password" name="password" id="password" class="form-control" placeholder="Minimal 8 karakter" required style="border-radius: 10px 0 0 10px; border-right: none;">
                                    <button class="btn btn-outline-secondary" type="button" id="btnToggle" style="border-radius: 0 10px 10px 0; background: white; border-left: none; color: #64748b;">
